...
HD_PWD='C:/Users/Vagary993/CPU/CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log INSTMEM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source INSTMEM.tcl -notrace
